                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/student/requestlab') }}">
                                            {{ csrf_field() }}
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                    <a href="{{url('student/timetable')}}"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="">
